...
import { findCompletedOrActiveGame, isUserInGame, parseEngineState } from '@/server/game-room';
      ...
      return (
         <main className='flex flex-1 flex-col items-center justify-center px-5 py-10'>
            <PiratePanel variant='deep' className='flex w-full max-w-sm flex-col items-center gap-3 text-center coral-glow'>
               ...
               <h1 className='pirate-display text-3xl text-[color:var(--color-coral-500)]'>
                  This voyage be underway
               </h1>
               <p className='text-sm text-[color:var(--color-cream-200)]/75'>
                  Game already started without you. Ask the captain for a new room.
               </p>
               <Link href='/choose-game' className='w-full'>
                  <PirateButton variant='tertiary' size='md' fullWidth>
                     Back to port
